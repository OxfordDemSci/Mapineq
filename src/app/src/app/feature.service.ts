...
export class FeatureService {
  ...
  constructor(private httpClient: HttpClient) {
    ...
    this.baseUrl = 'https://mapineqfeatures.web.rug.nl/collections/pgtileserv.unemployment/items.json';
  }

  public getFeatures(areas:any): Observable<any> {
    //areas.sort(())
    ...
    return this.httpClient.get<string>(`${this.baseUrl}?filter=NUTS_ID in (${nutsstring})&properties=year,entity&limit=100`).pipe(
      tap((result) => {
        //console.log(result);
      }),
